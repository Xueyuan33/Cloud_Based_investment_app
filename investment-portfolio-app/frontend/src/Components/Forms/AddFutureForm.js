...
function addFutureDataToBackend(data) {
    console.log(data);
    // Send the POST request using fetch
    fetch("http://129.114.27.23:1314/investments/futures", {
        method: "POST",
        headers: {
...
function Form() {
    return (
        <FormContainer defaultValues={{
            name: ''
          }} onSuccess={(data) => {addFutureDataToBackend(data)}}>
              <Stack spacing={2}>
...
export default function AddFutureForm() {
